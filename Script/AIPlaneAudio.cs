...
public class AIPlaneAudio : MonoBehaviour { //modified based on the "Vehicle" package
    [System.Serializable]
    ...
    private void Update()
    {
        var enginePowerProportion = Mathf.InverseLerp(0, AIPlaneController.MAX_THRUST, planeController.thrust);
        ...
        engineSound.volume = Mathf.InverseLerp(0, AIPlaneController.MAX_THRUST * advanced.engineMasterVolume, planeController.thrust);
